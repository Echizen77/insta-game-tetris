package com.insta.games.tetris.objects;
...
public class Tetromino {
    ...
    public int posX;
    public int posY;
    private com.insta.games.tetris.GameWorld gameWorld;
    ...
    public Tetromino(com.insta.games.tetris.GameWorld gameWorld, com.insta.games.tetris.WorldController worldController) {
